...
# Hi Dua. Good job on the assignment. I will have suggestions designated with a number sign (#) for you to look at.

1.  [**Data Inspection:**]{.ul}

-   To set working directory and open files:

# Just set it to my own working directory so I could run it.
    ```{r}
      setwd("C:/Users/Tanner/Desktop/Tanner/Iowa_State_Work/PhD_2020_2021/Bioinformatics_for_Biological_data/EEOB 546 R_Assignment/Dua_Vang_Review/DV_R-Assignment")
...
# This needs to be placed in a code chunk ctrl+alt+I
...
# You can also use tail to make sure notheing weird is going on here.
```{r}
summary(genotypes)
        summary(snp_pos)
...
# This needs to be added to a code block... It didn't let me run it right off the bat.

    -   Maize: ZMMIL, ZMMLR, and ZMMMR

    -   Teosinte: ZMPBA, ZMPIL, and ZMPJA
    
# You could have just search "ZMM" or "ZMP" but your way was more accurate in the event that three letters was not enough.
```{r}
...
# I like that you used rownames_to_column because this will allow you to have the file for future analyses.
    ```{r}
...
# I think you should remove the headers on genotype data, otherwise the first three rows get sorted into the data. Headerless_Transposed_ZMM_Grouped_Fang_geno= new_transposed_teo[-c(1,2,3),]
...
# set to my Working Directory

# I wouldn't change the working directory internally. This makes it difficult to run the code. It may be better to just have the files written to the larger file and then just transfer them at the end.
...
#Set to my working directory
    ...
    setwd("C:/Users/Tanner/Desktop/Tanner/Iowa_State_Work/PhD_2020_2021/Bioinformatics_for_Biological_data/EEOB 546 R_Assignment/Dua_Vang_Review/DV_R-Assignment/All_Maize_Genotypes/Increasing")
    ...
    setwd("C:/Users/Tanner/Desktop/Tanner/Iowa_State_Work/PhD_2020_2021/Bioinformatics_for_Biological_data/EEOB 546 R_Assignment/Dua_Vang_Review/DV_R-Assignment/All_Teosinte_Genotypes/Increasing")
    for (i in 1:10){
...
#Perhaps use "-/-" to fill in the gaps as what you have now only puts a dash in the place. This means that Hm and Ht data are uncertain if it is known here or not
    ```{r}
    ...
    #set directory to ensure your files are saved where you want them to
    setwd("C:/Users/Tanner/Desktop/Tanner/Iowa_State_Work/PhD_2020_2021/Bioinformatics_for_Biological_data/EEOB 546 R_Assignment/Dua_Vang_Review/DV_R-Assignment/All_Maize_Genotypes/Decreasing")
   ...
   setwd("C:/Users/Tanner/Desktop/Tanner/Iowa_State_Work/PhD_2020_2021/Bioinformatics_for_Biological_data/EEOB 546 R_Assignment/Dua_Vang_Review/DV_R-Assignment/All_Teosinte_Genotypes/Decreasing")
    for (i in 1:10){
...
# I would put all of the loading of packages at the beginning.
...
#Don't forget Distibution:
# ggplot(data = Filename) + geom_point(mapping = aes(x=Position, y=Chromosome))
...
# This crashed my R studio three times. I think it works but it's pretty intensive
    ```{r}
    m.genotype_new <- 
...
# Good Job Dua. I would update some of your code chunks as well as remove the change of directories in the middle of the document. Overall Good job though